...
setInterval(tick,1000);tick();
// change gpio
const DEFAULT_PINS=[4,5,6,7,15,16,17,18,1,2,3,10,11,12,20,19];
let gpioData=null;
...
void handleGetGPIOConfig() {
    ...
    // change gpio 
    int validPins[] = {4, 5, 6, 7, 15, 16, 17, 18, 1, 2, 3, 10, 11, 12, 20, 19, 13, 14};    
    for (int p : validPins) {
        available.add(p);
    }    
    String resp;
